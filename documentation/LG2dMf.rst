...
*class* ``ldft_classes_v2.lg_2d_highl.LG2Mf(self, size, epsi, mu_fix=False, mu=None, dens=None, v_ext=None, bound_cond='periodic', r=None, r_hist=None, err_hist=None, it_hist=None)``
...
``__init__(self, size, epsi, mu_fix=False, mu=None, dens=None, v_ext=None, bound_cond='periodic', r=None, r_hist=None, err_hist=None, it_hist=None)``
...
*classmethod* ``cal_bulk_f(cls, dens, epsi)``
...
*classmethod* ``cal_bulk_mu(cls, dens, epsi)``
...
*classmethod* ``cal_bulk_om(cls, r, epsi)``
...
*classmethod* ``cal_bulk_coex_dens(cls, mu, epsi)``
